...
public class StateMachine<TMonoBehaviour> : SealedSMB where TMonoBehaviour : MonoBehaviour
{
    ...
    {
        StateMachine<TMonoBehaviour>[] sceneLinkedSMBs = animator.GetBehaviours<StateMachine<TMonoBehaviour>>();
